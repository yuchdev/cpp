Chapters 10-12 Nicolai Josuttis
...
* Instantiation on demand. The compiler keeps a table of instantiations in a file,
  and searches for a pre-built implementation when a template needs to be instantiated.
...
* Iterative instantiation. Using this approach we compile the source code and try linking, 
  then we analyze the linker errors and iteration is repeated.
